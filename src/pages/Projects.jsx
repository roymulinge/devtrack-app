        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Control panel for your builds — track, resume, complete.
            </p>
          </div>
            ...
            {allSkills.length > 0 && (
              <div>
                <label className="text-sm font-medium text-gray-300">
                  Skills used in this project <span className="text-gray-500 text-xs">(optional)</span>
                </label>
        ...
        {projects.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {projects.map((project) => {
              ...
              const completedAssignments = project.assignments?.filter(a => a.status === "completed").length || 0;
                ...
                >
                  ...
                  {totalAssignments > 0 && (
                    <div className="mt-3">
                      <div className="flex justify-between text-xs text-gray-400 mb-1">
                        <span>Progress</span>
                        <span>{completedAssignments}/{totalAssignments} tasks</span>
                      </div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {project.skills_detail.slice(0, 3).map((skill) => {
                        ...
                        return (
                          <span
                            key={skill.id}
                            className={`text-xs px-2 py-0.5 rounded-full border ${d.bg} ${d.text} ${d.border}`}
                          >
                            {skill.name}
                          </span>
                        );
                  ...
                  <div className="mt-4 pt-3 border-t border-white/5 flex justify-between items-center">
                    <Link
                      ...
                      className="text-sm bg-blue-600/20 hover:bg-blue-600/30 text-blue-300 px-3 py-1.5 rounded-lg transition-all"
                    >
                      Next action: Resume →
                    </Link>
                    <button
