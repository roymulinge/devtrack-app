  ...
  return (
    <div className="min-h-screen bg-[#080b10] text-white">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Weekly Summary Stats - clean, minimal cards */}
        {summary && (
        ...
        {/* Two column: Assignments Due + Skills to Practice */}
            ...
            {focus?.urgent_assignments?.length === 0 ? (
              ...
              <div className="space-y-3">
                {focus?.urgent_assignments?.map((a) => {
                  ...
                  if (days < 0) { urgencyClass = "text-red-400"; dotClass = "bg-red-400"; }
                  else if (days <= 3) { urgencyClass = "text-amber-400"; dotClass = "bg-amber-400"; }
                  else { urgencyClass = "text-emerald-400"; dotClass = "bg-emerald-400"; }
                  return (
        ...
        <div className="rounded-xl bg-[#0f1217] border border-white/5 p-5 mb-6 hover:bg-[#161b22] transition-all">
            ...
            <ol className="space-y-3 mb-5">
              {priorities.map((item, i) => (
                <li key={i} className="flex items-center gap-3 group">
                  <span className="text-lg font-bold text-gray-500 w-6 shrink-0">0{i+1}</span>
          ...
          <form onSubmit={savePriority} className="flex gap-2">
            <input
              ...
              className="flex-1 bg-black/40 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-all"
            />
            <button
              type="submit"
        ...
        <div className="rounded-xl bg-[#0f1217] border border-white/5 p-5 mb-6 hover:bg-[#161b22] transition-all">
          ...
          <textarea
            ...
            className="w-full bg-black/40 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-all resize-none"
          />
        ...
        <div className="rounded-xl bg-[#0f1217] border border-white/5 p-5 hover:bg-[#161b22] transition-all">
          ...
          {summary?.overdue_assignments > 0 && (
            <p className="text-xs text-amber-400 text-center mt-4">⚠️ {summary.overdue_assignments} assignment(s) still pending – let's clear them.</p>
          )}
        </div>
      </div>
    </div>
