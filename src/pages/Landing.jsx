  ...
  return (
    <div className="bg-white dark:bg-[#080b10] text-gray-900 dark:text-white min-h-screen antialiased">
      ...
      <style>{`
        ...
        .mock-bar { height: 6px; border-radius: 3px; }
      `}</style>
      ...
      <div className="landing-root relative overflow-hidden">
        ...
        {/* ── NAV ──────────────────────────────────────── */}
        <nav className="relative z-10 border-b border-gray-200/60 dark:border-white/5 bg-white/70 dark:bg-[#080b10]/80 backdrop-blur-md">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={skill.name}>
                          ...
                          <div className="w-full bg-gray-200 dark:bg-white/8 mock-bar">
                            <div className={`mock-bar ${skill.color} opacity-70`} style={{ width: `${skill.pct}%` }} />
                          </div>
                        </div>
                      ))}
                    </div>
